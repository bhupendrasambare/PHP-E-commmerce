...
<div class="cart container">
  ...
  <div class="d-flex flex-row-reverse bd-highlight">
    <div class="p-2 bd-highlight total-cart-value">Total charges  📜</div>
    </div>
    <div class="cart-container">
      ...
      <div class="quantity-box">
        <div class="cart-product-qt-box mt-2">
          Total value <span class="text-success">1000</span>
        </div>
      </div>
      <div class="quantity-box">
          <form action="" class="cart-product-qt-box mt-2">
            <input type="text" name="delete_item" disabled hidden value="111111">
            <button class="btn btn-danger mr-3">Delete</button>
          </form>
          <form action="" class="cart-product-qt-box mt-2">
            <input type="text" name="buy_item" disabled hidden value="111111">
